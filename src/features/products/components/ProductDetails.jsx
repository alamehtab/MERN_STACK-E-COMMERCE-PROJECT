...
import { fetchProductDetailsByIdAsync, selectProductId } from '../productSlice'
            ...
            {product && (<div className="pt-6">
                ...
                <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                    <img
                        ...
                        alt={product.title}
                        className="border-1 hidden size-full rounded-lg object-cover lg:block"
                    />
                    <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                        <img
                            src={product.images[2]}
                            alt={product.title}
                            className="border-1 aspect-3/2 w-full rounded-lg object-cover"
                        />
                        <img
                            src={product.images[2]}
                            alt={product.title}
                    ...
                    <img
                        ...
                        alt={product.title}
                        className=" border-1 aspect-4/5 size-full object-cover sm:rounded-lg lg:aspect-auto"
                    />
                </div>
